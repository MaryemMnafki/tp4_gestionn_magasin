package tn.tuniprob.Exercice3;
import tn.tuniprob.Exercice1.Produit;
import tn.tuniprob.Exercice2.Magasin;
public class Main {
    public static void main(String[] args) {
        ...
        Caissier caissier1=new Caissier(10,5,"wael","Sidi bouzid",2);
        Caissier caissier2=new Caissier(11,6,"mourad","Sidi bouzid",3);
        ...
        Caissier caissier4=new Caissier(12,6,"nizar","Menzah6",3);
        Caissier caissier5=new Caissier(13,6,"chaker","Menzah6",3);
        Vendeur vendeur=new Vendeur(15,8,"hazar","Sidi bouzid",50);
